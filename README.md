...
### Modelado: GLM y GAM (`glm_analysis.py`)
...
- **GAM 2**: Es el place field predictivo del GAM. El place field se expresa en este caso como un gradiente suave y continuo, reflejando de manera más natural la probabilidad espacial de la célula (comparar con modelos lineales).
